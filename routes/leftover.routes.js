...
const controller = require('../controllers/leftover.controller');
const validator = require('../middleware/validators/leftover.params.validator');

const router = new Router({ prefix: '/api/leftover' });
